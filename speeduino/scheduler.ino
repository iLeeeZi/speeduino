...
static inline void fuelSchedule1Interrupt() //Most ARM chips can simply call a function
#endif
  {
    if (fuelSchedule1.Status == PENDING) //Check to see if this schedule is turn on
    {
      ...
      if (configPage2.injLayout == INJ_SEMISEQUENTIAL) { openInjectorPair1(); }
      else { openInjector1(); }
    ...
    else if (fuelSchedule1.Status == RUNNING)
    {
       ...
       if (configPage2.injLayout == INJ_SEMISEQUENTIAL) { closeInjectorPair1(); }
       else { closeInjector1(); }
...
static inline void fuelSchedule2Interrupt() //Most ARM chips can simply call a function
#endif
  {
    if (fuelSchedule2.Status == PENDING) //Check to see if this schedule is turn on
    {
      ...
      if (configPage2.injLayout == INJ_SEMISEQUENTIAL) { openInjectorPair2(); }
      else { openInjector2(); }
    ...
    else if (fuelSchedule2.Status == RUNNING)
    {
       ...
       if (configPage2.injLayout == INJ_SEMISEQUENTIAL) { closeInjectorPair2(); }
       else { closeInjector2(); }
...
static inline void fuelSchedule3Interrupt() //Most ARM chips can simply call a function
#endif
  {
    if (fuelSchedule3.Status == PENDING) //Check to see if this schedule is turn on
    {
      ...
      //Hack for 5 cylinder
      if ( (configPage2.injLayout == INJ_SEMISEQUENTIAL) || (configPage2.nCylinders == 5) ) { openInjectorPair3(); }
      else { openInjector3(); }
    ...
    else if (fuelSchedule3.Status == RUNNING)
    {
      ...
      //Hack for 5 cylinder
       if ( (configPage2.injLayout == INJ_SEMISEQUENTIAL) || (configPage2.nCylinders == 5) ) { closeInjectorPair3(); }
       else { closeInjector3(); }
