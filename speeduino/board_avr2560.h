...
*/
  ...
  #define IGN4_COMPARE  OCR4A //Replaces injector 4
  #define IGN5_COMPARE  OCR4B //Replaces injector 5
  #define IGN6_COMPARE  OCR4C //Replaces injector 6
  ...
  #define FUEL4_TIMER_ENABLE() TIFR4 |= (1<<OCF4A); TIMSK4 |= (1 << OCIE4A) //Turn on the A compare unit (ie turn on the interrupt)
  #define FUEL5_TIMER_ENABLE() TIFR4 |= (1<<OCF4B); TIMSK4 |= (1 << OCIE4B) //Turn on the B compare unit (ie turn on the interrupt)
  #define FUEL6_TIMER_ENABLE() TIFR4 |= (1<<OCF4C); TIMSK4 |= (1 << OCIE4C) //Turn on the C compare unit (ie turn on the interrupt)
